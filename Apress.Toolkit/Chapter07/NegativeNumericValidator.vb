...
Namespace Apress.Toolkit.Validation
    ...
    Public Class NegativeNumericValidator
        ...
        Private Function BuildPattern(ByRef val As ValidatorControl) As String
            ...
            'Remarks: the negative sign is required now.
            With val.Culture.NumberFormat
                sb.Append("^\").Append(.NegativeSign)
        ...
        Public Overrides Function GetScriptForKeyPress(ByVal validator As ValidatorControl) As String
            ...
            '      (e.KeyChar == CultureInfo.NumberFormat.PositiveSign) || 
            '      (e.KeyChar == CultureInfo.NumberFormat.NegativeSign && sender.Text.IndexOf(CultureInfo.NumberFormat.NegativeSign) != -1) || 
            ...
            sb.Append("(e.KeyChar == CultureInfo.NumberFormat.PositiveSign) || ")
            sb.Append("(e.KeyChar == CultureInfo.NumberFormat.NegativeSign && sender.Text.IndexOf(CultureInfo.NumberFormat.NegativeSign) != -1) || ")
